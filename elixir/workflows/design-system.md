...
tracker:
  kind: linear
  project_slug: "design-system-937ae463bc9c"
  active_states:
    - Todo
    - In Progress
    - Merging
...
polling:
  interval_ms: 60000
workspace:
  root: ~/code/symphony-workspaces/design-system
repo:
  name: design-system
  github_repo: Subconscious-ai/design-system
  default_branch: main
hooks:
  timeout_ms: 600000
  after_create: |
    set -eu
    git clone https://github.com/Subconscious-ai/design-system.git .
...
You are working on Linear ticket `{{ issue.identifier }}` for the `design-system` repository.
